  ...
  share : (el) ->
    ...
    switch site
      ...
      when "twitter"
        ...
        SocialShareButton.openUrl("https://twitter.com/intent/tweet?url=#{url}#{via_str}",popup)
      when "douban"
      ...
      when "linkedin"
        SocialShareButton.openUrl("https://www.linkedin.com/shareArticle?url=#{url}&title=#{title}&description=#{desc}&source=#{url}&mini=true", popup)
      when "tumblr"
