...
ActiveRecord::Schema.define(version: 20160714081752) do
  ...
  create_table "product_relations", id: false, force: :cascade do |t|
    t.integer "related_id",         null: false
    t.integer "inverse_related_id", null: false
  end

  add_index "product_relations", ["inverse_related_id"], name: "index_product_relations_on_inverse_related_id", using: :btree
  add_index "product_relations", ["related_id"], name: "index_product_relations_on_related_id", using: :btree
  ...
  create_table "spree_assets", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "is_perfect_match",                   default: false, null: false
  end
  ...
  create_table "spree_audios", force: :cascade do |t|
  ...
  add_index "spree_audios", ["product_id"], name: "index_spree_audios_on_product_id", using: :btree
  ...
  add_index "spree_blog_entries", ["user_id"], name: "index_spree_blog_entries_on_user_id", using: :btree

  create_table "spree_calculator_backgrounds", force: :cascade do |t|
    t.integer  "calculator_event_id"
  ...
  add_index "spree_calculator_backgrounds", ["calculator_event_id"], name: "index_spree_calculator_backgrounds_on_calculator_event_id", using: :btree
  add_index "spree_calculator_backgrounds", ["calculator_month_id"], name: "index_spree_calculator_backgrounds_on_calculator_month_id", using: :btree

  create_table "spree_calculator_event_products", force: :cascade do |t|
    t.integer "calculator_event_id", null: false
    t.integer "product_id",          null: false
  end

  add_index "spree_calculator_event_products", ["calculator_event_id"], name: "index_spree_calculator_event_products_on_calculator_event_id", using: :btree
  add_index "spree_calculator_event_products", ["product_id"], name: "index_spree_calculator_event_products_on_product_id", using: :btree

  create_table "spree_calculator_events", force: :cascade do |t|
    t.string "name"
    t.float  "red_rate",   default: 1.0
    t.float  "white_rate", default: 1.0
  end

  create_table "spree_calculator_month_products", id: false, force: :cascade do |t|
    t.integer "calculator_month_id", null: false
    t.integer "product_id",          null: false
  end

  add_index "spree_calculator_month_products", ["calculator_month_id"], name: "index_spree_calculator_month_products_on_calculator_month_id", using: :btree
  add_index "spree_calculator_month_products", ["product_id"], name: "index_spree_calculator_month_products_on_product_id", using: :btree

  create_table "spree_calculator_months", force: :cascade do |t|
    t.string "name"
  ...
  add_index "spree_comments", ["root_commentable_id"], name: "index_spree_comments_on_root_commentable_id", using: :btree
  ...
  create_table "spree_featured_items", force: :cascade do |t|
  ...
  add_index "spree_featured_items", ["spree_product_id"], name: "index_spree_featured_items_on_spree_product_id", using: :btree
  ...
  add_index "spree_grades", ["quiz_id"], name: "index_spree_grades_on_quiz_id", using: :btree

  create_table "spree_grades_results", force: :cascade do |t|
  ...
  add_index "spree_grades_results", ["grade_id"], name: "index_spree_grades_results_on_grade_id", using: :btree
  add_index "spree_grades_results", ["user_id"], name: "index_spree_grades_results_on_user_id", using: :btree
  ...
  create_table "spree_map_markers", force: :cascade do |t|
    t.string   "place_id"
    t.string   "name"
    t.text     "address"
    t.float    "lat"
    ...
    t.integer  "image_file_size"
    t.datetime "image_updated_at"
    t.integer  "dependency",         default: 0
    t.string   "name_it"
    t.text     "address_it"
    t.text     "description"
    t.text     "description_it"
  ...
  add_index "spree_map_markers", ["place_id"], name: "index_spree_map_markers_on_place_id", using: :btree

  create_table "spree_news_entries", force: :cascade do |t|
    t.text     "preview_text"
    t.text     "full_text"
    t.integer  "view_count",   default: 0
    t.date     "posted_on"
  ...
  create_table "spree_news_entry_relations", id: false, force: :cascade do |t|
    t.integer "related_id",         null: false
    t.integer "inverse_related_id", null: false
  end

  add_index "spree_news_entry_relations", ["inverse_related_id"], name: "index_spree_news_entry_relations_on_inverse_related_id", using: :btree
  add_index "spree_news_entry_relations", ["related_id"], name: "index_spree_news_entry_relations_on_related_id", using: :btree

  create_table "spree_nominations", force: :cascade do |t|
    t.integer  "grade_id",          null: false
    t.string   "title"
    t.integer  "min"
    t.integer  "position"
  ...
  add_index "spree_nominations", ["grade_id"], name: "index_spree_nominations_on_grade_id", using: :btree
  ...
  create_table "spree_product_descriptions", force: :cascade do |t|
    t.text     "body"
    t.integer  "position"
    t.integer  "product_id"
  ...
  create_table "spree_product_properties", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.integer  "position",      default: 0
    t.integer  "type_of_value", default: 0
    t.text     "value_array",   default: [], array: true
    t.string   "category"
  end
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.string   "meta_title"
    t.integer  "wine_glass_id"
    t.string   "video_mp4"
    t.string   "video_ogg"
    t.string   "video_webm"
    t.string   "producer"
    t.string   "geographic_setting"
  end
  ...
  create_table "spree_questions", force: :cascade do |t|
    ...
    t.hstore   "variants",      default: [], null: false, array: true
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "spree_questions", ["grade_id"], name: "index_spree_questions_on_grade_id", using: :btree
  add_index "spree_questions", ["variants"], name: "index_spree_questions_on_variants", using: :btree

  create_table "spree_quizzes", force: :cascade do |t|
    t.string   "title"
    t.string   "description"
    t.integer  "position"
    t.datetime "created_at"
  ...
  create_table "spree_topics", force: :cascade do |t|
    t.integer  "product_id"
    t.string   "title"
    t.string   "image_file_name"
    t.string   "image_content_type"
  ...
  create_table "spree_wineries", force: :cascade do |t|
    t.string   "title"
    t.string   "title_it"
    t.text     "video_mp4"
    t.integer  "status",             default: 0
